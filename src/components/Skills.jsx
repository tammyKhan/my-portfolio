...
const technicalSkills = [
  ...
  { name: 'React', icon: <FaReact size={40} />, progress: 90 },
  { name: 'Tailwind CSS', icon: <SiTailwindcss size={40} />, progress: 85 },
  { name: 'DaisyUI', icon: <SiDaisyui size={40} />, progress: 80 },
  { name: 'Node.js', icon: <FaNodeJs size={40} />, progress: 60 },
  { name: 'Databases (MongoDB, PostgreSQL)', icon: <FaDatabase size={40} />, progress: 50 },
];

const softSkills = [
  { name: 'Problem Solving', progress: 87 },
  { name: 'Teamwork', progress: 90 },
  { name: 'Communication', progress: 80 },
  { name: 'Adaptability', progress: 75 },
